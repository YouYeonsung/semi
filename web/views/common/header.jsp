						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<div class="dropdown-menu">
									<ul>
										<li><a href="<%=request.getContextPath() %>/service.html">Easy Matching</a></li>
										<!--매칭 시작-->
										<li><a href="<%=request.getContextPath() %>/portfolio-classic.html">Searching Petsitter</a></li>
										<!--펫시터만 검색-->
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">펫시터<i
										class="fa fa-angle-down"></i></a>
								<div class="dropdown-menu">
									<ul>
										<li><a href="team.html">Our Team</a></li>
										<li><a href="<%=request.getContextPath() %>/views/petsitter/petsitterInfo.jsp">일반펫시터</a></li>
										<li><a href="<%=request.getContextPath() %>/service2.html">전문펫시터</a></li>
										<li><a href="<%=request.getContextPath() %>/service-single.html">Customers Services</a></li>

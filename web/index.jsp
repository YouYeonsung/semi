			...
			<div id="main-slide" class="ts-flex-slider">
				...
				<div class="flexSlideshow flexslider">
					<ul class="slides">
						<li>
							<div class="overlay2">
								<img class="" src="<%=request.getContextPath() %>/images/slider/bg1.jpg" alt="slider">
							</div>
							<div class="flex-caption slider-content">
								<div class="col-md-12 text-center">
									...
									<p class="animated4"><a href="<%=request.getContextPath() %>/#" class="slider btn btn-primary white">Check Now</a>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="overlay2">
								<img class="" src="<%=request.getContextPath() %>/images/slider/bg2.jpg" alt="slider">
							</div>
							<div class="flex-caption slider-content">
								<div class="col-md-12 text-center">
									<h2 class="animated4">
									...
									<p class="animated6"><a href="<%=request.getContextPath() %>/#" class="slider btn btn-primary white">Buy Now</a>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="overlay2">
								<img class="" src="<%=request.getContextPath() %>/images/slider/bg3.jpg" alt="slider">
							</div>
							<div class="flex-caption slider-content">
								<div class="col-md-12 text-center">
									<h2 class="animated7">
									...
									<div class="">
										<a class="animated4 slider btn btn-primary btn-min-block white" href="<%=request.getContextPath() %>/#">Get
											Now</a><a class="animated4 slider btn btn-primary btn-min-block solid"
				...
				<div class="row">
					<div class="landing-tab clearfix">
						<ul class="nav nav-tabs nav-stacked col-md-3 col-sm-5">
							...
							<li>
								<a class="animated fadeIn" href="<%=request.getContextPath() %>/#tab_e" data-toggle="tab">
						...
						<div class="tab-content col-md-9 col-sm-7">
							...
							<div class="tab-pane animated fadeInLeft" id="tab_b">
								...
								<p>
									...
									<br>
									 - 보호자의 하네스와 도그메이트 이중 산책줄을 사용해 더욱 안전하고 즐겁게 산책을 진행합니다
									<br>
					...
					<div class="col-md-6 ts-padding img-block-right">
						<div class="img-block-head text-center">
							...
							<p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis
								sem nibh id elit. Proin gravida nibh vel velit auctor Aenean sollicitudin, adipisicing
								elit sed lorem quis bibendum auctor.
							</p>
						</div>
				...
				<div class="row facts-wrapper wow fadeInLeft text-center">
					...
					<div class="facts four col-md-3 col-sm-6">
						...
						<span class="counter">4.75</span><span style="font-size: 43px">
							<span style="font-size: 15px">pts</span>  /  </span>  
								<span class="counter" >12,838</span>
						</div>
						<h3>Avg Pts/ Works</h3>
					</div>
			...
			<div class="container">
				...
				<div class="row text-center">
					<div class="isotope-nav" data-isotope-nav="isotope">
						<ul>
							<li><a href="<%=request.getContextPath() %>/#" class="active" data-filter="*">All</a></li>
							<li><a href="<%=request.getContextPath() %>/#" data-filter=".web-design">Web Design</a></li>
							<li><a href="<%=request.getContextPath() %>/#" data-filter=".development">Development</a></li>
							<li><a href="<%=request.getContextPath() %>/#" data-filter=".joomla">Joomla</a></li>
							<li><a href="<%=request.getContextPath() %>/#" data-filter=".wordpress">Wordpress</a></li>
						</ul>
					</div>
				...
				<div class="row">
					<div id="isotope" class="isotope">
						<div class="col-sm-3 web-design isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/<%=request.getContextPath() %>/images/portfolio/portfolio1.jpg" alt="">
									<figcaption>
						...
						<div class="col-sm-3 development isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio2.jpg" alt="">
									<figcaption>
										<h3>Easy to Lanunch</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
										<a class="view icon-pentagon" data-rel="prettyPhoto"
											href="<%=request.getContextPath() %>/images/portfolio/portfolio-bg2.jpg"><i class="fa fa-search"></i></a>
									</figcaption>
								</figure>
							</div>
						</div><!-- Isotope item end -->
						...
						<div class="col-sm-3 joomla isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio3.jpg" alt="">
									<figcaption>
										<h3>Your Business</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
										<a class="view icon-pentagon" data-rel="prettyPhoto"
											href="<%=request.getContextPath() %>/images/portfolio/portfolio-bg3.jpg"><i class="fa fa-search"></i></a>
									</figcaption>
								</figure>
							</div>
						</div><!-- Isotope item end -->
						...
						<div class="col-sm-3 wordpress isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio4.jpg" alt="">
									<figcaption>
										<h3>Prego Match</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
										<a class="view icon-pentagon" data-rel="prettyPhoto"
											href="<%=request.getContextPath() %>/images/portfolio/portfolio-bg4.jpg"><i class="fa fa-search"></i></a>
									</figcaption>
								</figure>
							</div>
						</div><!-- Isotope item end -->
						...
						<div class="col-sm-3 joomla isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio5.jpg" alt="">
									<figcaption>
										<h3>Fashion Brand</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
										<a class="view icon-pentagon" data-rel="prettyPhoto"
											href="<%=request.getContextPath() %>/images/portfolio/portfolio-bg5.jpg"><i class="fa fa-search"></i></a>
									</figcaption>
								</figure>
							</div>
						</div><!-- Isotope item end -->
						...
						<div class="col-sm-3 development isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio6.jpg" alt="">
									<figcaption>
										<h3>The Insidage</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
										<a class="view icon-pentagon" data-rel="prettyPhoto"
											href="<%=request.getContextPath() %>/images/portfolio/portfolio-bg1.jpg"><i class="fa fa-search"></i></a>
									</figcaption>
								</figure>
							</div>
						</div><!-- Isotope item end -->
						...
						<div class="col-sm-3 development isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio7.jpg" alt="">
									<figcaption>
										<h3>Light Carpet</h3>
										<a class="link icon-pentagon" href="<%=request.getContextPath() %>/portfolio-item.html"><i
												class="fa fa-link"></i></a>
						...
						<div class="col-sm-3 development isotope-item">
							<div class="grid">
								<figure class="effect-oscar">
									<img src="<%=request.getContextPath() %>/images/portfolio/portfolio8.jpg" alt="">
									<figcaption>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<p>
							<a href="<%=request.getContextPath() %>/#" class="btn btn-primary white">Purchase Now</a>
							<a href="<%=request.getContextPath() %>/#" class="btn btn-primary solid">Get In Touch</a>
						</p>
					</div>
				</div>
			</div><!-- Container end -->
			...
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-3 col-sm-6">
						<div class="team wow slideInLeft">
							<div class="img-hexagon">
								<img src="<%=request.getContextPath() %>/images/team/team1.jpg" alt="">
							...
							<div class="team-content">
								...
								<div class="team-social">
									<a class="fb" href="<%=request.getContextPath() %>/#"><i class="fab fa-facebook"></i></a>
									<a class="twt" href="<%=request.getContextPath() %>/#"><i class="fab fa-twitter"></i></a>
									<a class="gplus" href="<%=request.getContextPath() %>/#"><i class="fab fa-google-plus"></i></a>
									<a class="linkdin" href="<%=request.getContextPath() %>/#"><i class="fab fa-linkedin"></i></a>
									<a class="dribble" href="<%=request.getContextPath() %>/#"><i class="fas fa-phone"></i></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team wow slideInLeft">
							<div class="img-hexagon">
								<img src="<%=request.getContextPath() %>/images/team/team2.jpg" alt="">
								<span class="img-top"></span>
								<span class="img-bottom"></span>
							</div>
							<div class="team-content">
					...
					<div class="col-md-3 col-sm-6">
						<div class="team wow slideInRight">
							<div class="img-hexagon">
								<img src="<%=request.getContextPath() %>/images/team/team3.jpg" alt="">
								<span class="img-top"></span>
								<span class="img-bottom"></span>
							</div>
							<div class="team-content">
					...
					<div class="col-md-3 col-sm-6">
						<div class="team animate wow slideInRight">
							<div class="img-hexagon">
								<img src="<%=request.getContextPath() %>/images/team/team4.jpg" alt="">
								<span class="img-top"></span>
								<span class="img-bottom"></span>
							</div>
							<div class="team-content">
					...
					<div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
						<div class="item">
							<div class="testimonial-thumb">
								<img src="<%=request.getContextPath() %>/images/team/testimonial1.jpg" alt="testimonial">
							</div>
						...
						<div class="item">
							<div class="testimonial-thumb">
								<img src="<%=request.getContextPath() %>/images/team/testimonial2.jpg" alt="testimonial">
							</div>
							<div class="testimonial-content">
								<p class="testimonial-text">
									Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover
						...
						<div class="item">
							<div class="testimonial-thumb">
								<img src="<%=request.getContextPath() %>/images/team/testimonial3.jpg" alt="testimonial">
							</div>
							<div class="testimonial-content">
								<p class="testimonial-text">
									Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover
